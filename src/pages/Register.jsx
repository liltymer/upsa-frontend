    ...
    <div style={{
      ...
      <div className="login-left" style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Create your account to start tracking your CGPA,
            monitoring academic risk, and planning your
            path to graduation.
          </p>
            ...
            {[
              ...
              <div key={i} style={{
                ...
                <span style={{
                  ...
                  background: step > i ? "var(--gold)" : "rgba(255,192,5,0.1)",
                  border: `1px solid ${step > i ? "var(--gold)" : "rgba(255,192,5,0.25)"}`,
                  display: "flex", alignItems: "center",
                  justifyContent: "center",
                  fontFamily: "var(--font-heading)",
                  fontWeight: 900, fontSize: 10,
                  color: step > i ? "var(--navy)" : "var(--gold)",
                  flexShrink: 0,
                }}>
                  {step > i ? "✓" : item.num}
                </span>
          ...
          <div style={{
            ...
            <p style={{
              ...
              fontFamily: "var(--font-heading)", marginBottom: 5,
      ...
      <div style={{
        ...
        <div className="mobile-header" style={{
          ...
          <div style={{
            width: 36, height: 36,
            background: "var(--navy)", borderRadius: 9,
            display: "flex", alignItems: "center",
            ...
            {[1, 2].map((s) => (
              <div key={s} style={{
                ...
                {s === 1 && (
                  <div style={{
                    width: 28, height: 2,
                    background: step > 1 ? "var(--navy)" : "var(--border)",
                    borderRadius: 999,
                    transition: "all 0.3s",
                  }} />
                )}
